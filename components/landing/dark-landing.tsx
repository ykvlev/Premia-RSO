...
export const NOMINATIONS: Nomination[] = [
  // 1.1 — Организации, осуществляющие трудоустройство участников студотрядов
  {
    ...
    criteria: ["Трудовые проекты организации и их география", "Количество трудоустроенных участников трудовых отрядов подростков", "Медианная заработная плата у бойцов трудовых отрядов подростков", "Опыт организации социальных проектов во взаимодействии с трудовыми отрядами подростков", "Уникальные проекты и механика взаимодействия с трудовыми отрядами подростков"],
  },
  {
    id: "02",
    category: "Работодатель",
    ...
    criteria: ["Количество трудоустроенных участников студенческих отрядов", "Система управления охраной труда при трудоустройстве участников студенческих отрядов", "Механизм сопровождения участников в период трудового проекта", "Механизм профилактики производственного травматизма", "Результативность системы охраны труда (качественные и количественные показатели)", "Мероприятия по формированию культуры безопасного труда"],
  },
  {
    id: "03",
    category: "Физическое лицо",
    title: "«Лидер студенческих отрядов» (командиры и комиссары трудовых проектов)",
    accent: "#0804ff",
    description:
    ...
    criteria: ["Видеопрезентация участника", "Эффективность руководства трудовым проектом, личный вклад в развитие студенческих отрядов", "Оценка реализованного проекта под руководством участника (отчёт)", "Портфолио участника"],
  },
  {
    id: "04",
    category: "Ссуз / школа",
    ...
    criteria: ["Масштаб и охват деятельности студотрядов", "Система поддержки и развития студотрядов", "Достижения и результаты деятельности", "Взаимодействие с работодателями и партнёрами"],
  },
  {
    id: "05",
    ...
    criteria: ["Наличие и уровень подписанных соглашений, системность взаимодействия, создание совместной инфраструктуры", "Количество и описание социально-значимых мероприятий совместно с МООО «РСО»", "Организованная система наставничества со стороны кадровых сотрудников компании", "Количество и описание трудовых проектов всероссийского/окружного/межрегионального уровней совместно с МООО «РСО»", "Публикации и упоминания совместной деятельности в инфоресурсах и СМИ", "Программы финансовой поддержки", "Наличие мультиформатного пространства «СО.здание» / коворкинга / штаба"],
  },
  // 1.2 — Региональные отделения МООО «РСО» и участники движения
  {
    ...
    criteria: ["Наличие официального документа деятельности совета ветеранов", "Количество и описание мероприятий, организованных советом ветеранов", "Участие во Всероссийской акции «День ударного труда» 2026", "Количество ветеранов советского периода в субъекте РФ", "Количество ветеранов и выпускников современного движения", "Механизм работы с выпускниками МООО «РСО» в региональном отделении", "Вклад в формирование музеев, экспозиций, стендов о студотрядах"],
  },
  {
    id: "07",
    category: "Физическое лицо",
    ...
    criteria: ["История героя — значимость поступка и его влияние на движение"],
  },
  {
    id: "08",
    category: "Физическое лицо",
    ...
    criteria: ["Опыт работы в движении студенческих отрядов", "Социальная и профессиональная активность по популяризации движения", "Проекты, реализованные по инициативе / под руководством, и их результаты", "Видеовизитка — раскрытие опыта и темы лидерства (до 1 мин)", "Портфолио — полнота и качество представленных материалов"],
  },
  // 1.3 — Органы государственной власти субъектов РФ
  {
    ...
    criteria: ["Наличие действующего соглашения между МООО «РСО» и Правительством региона", "Наличие регионального закона о студенческих отрядах", "Наличие здания студенческих отрядов в регионе", "Наличие программы поддержки трудоустройства трудовых отрядов подростков", "Программы финансовой поддержки студенческих отрядов в регионе", "Меры нематериальной поддержки студенческих отрядов в регионе"],
  },
  {
    id: "10",
    category: "Орган власти",
    ...
    criteria: ["Наличие региональной программы поддержки ТОП", "Объём финансирования ТОП из бюджета субъекта РФ", "Количество созданных рабочих мест для подростков (через ТОП)", "Количество трудовых отрядов подростков на территории РФ", "Поддержка приёма участников ТОП из других субъектов РФ", "Меры нематериальной поддержки трудовых отрядов подростков", "Меры поддержки работодателям (субсидии, гранты, льготы, методпомощь)"],
  },
...
const STAGES = [
  {
    num: "01",
    period: "1 сентября — 30 ноября 2026",
    title: "Приём заявок",
  ...
  {
    num: "02",
    period: "30 ноября — 31 декабря 2026",
    title: "Экспертная оценка",
    desc: "Независимые эксперты из числа лидеров отрасли, педагогов и представителей органов исполнительной власти оценивают заявки по утверждённым критериям. Каждая номинация рассматривается профильной экспертной группой. По итогам оценки формируется перечень финалистов премии по каждой номинации.",
  },
  {
    num: "03",
    period: "17 февраля 2027",
    title: "Церемония награждения",
    desc: "Торжественная церемония подведения итогов Национальной премии «Труд крут» пройдёт в Москве. Прямая трансляция, широкое освещение в федеральных СМИ. Лучшие практики сезона будут опубликованы на сайте премии.",
  },
];
...
function Header({
  ...
  stagesRef: React.RefObject<HTMLElement | null>;
        ...
        <div className="about-right">
          ...
          >
            ...
            >
              ...
              достижений тех, кто вносит вклад в развитие молодёжного трудового
              движения страны.
            </p>
            <p
              style={{
            ...
            >
              ...
              наставники — все они формируют будущее трудового движения. Премия — наш способ
              сказать вам спасибо.
            </p>
            {/* stat grid */}
            <div
...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Приём заявок открыт до 30 ноября 2026 года. Точные сроки и условия — в положении о премии.",
  },
  {
    q: "Можно ли подать заявки на несколько номинаций?",
    a: "Да. Одним аккаунтом (по вашему email) можно подать несколько заявок на разные номинации — все они будут видны в личном кабинете. Но в одну и ту же номинацию одна организация может подать заявку только один раз.",
  },
  {
  ...
  {
    q: "Кто оценивает заявки?",
    a: "Независимые эксперты — лидеры отрасли, педагоги, представители органов исполнительной власти и ветераны РСО. Каждая номинация рассматривается профильной экспертной группой, по итогам оценки формируется список финалистов.",
  },
  {
    q: "Сколько номинаций в сезоне?",
    a: "В сезоне 2026 — 12 номинаций: от лучшего работодателя до лидера студотрядов и СМИ. Полный перечень с описанием — в разделе «Номинации» выше.",
  },
  {
    q: "Можно ли редактировать заявку после отправки?",
    a: "До истечения срока приёма заявки (30 ноября 2026) можно отозвать и подать заново через поддержку оргкомитета (r.s.o@mail.ru). После 30 ноября заявки уходят на оценку.",
  },
  {
    q: "Где найти положение о премии?",
    a: "В разделе «Контакты» ниже — документы премии (PDF). Там же — положения по каждой номинации.",
  },
];
...
function FaqSection() {
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(420px, 1fr))", gap: "0 48px" }}>
        {FAQ.map((item, i) => (
  ...
  return (
    <MotionConfig reducedMotion="user">
      <div style={{ background: "#08080a", minHeight: "100vh" }}>
        ...
        <CursorSpotlight />
        <FilmGrain />
        <Header nominationsRef={nominationsRef} aboutRef={aboutRef} stagesRef={stagesRef} contactsRef={contactsRef} />
        <main>
          <Hero
          ...
          />
          <PatternBand />
          <div ref={aboutRef as React.RefObject<HTMLDivElement>}><AboutSection stats={stats} /></div>
          <GeographySection regionCounts={stats?.regionCounts} />
          <NominationsSection sectionRef={nominationsRef} />
          <div ref={stagesRef as React.RefObject<HTMLDivElement>}><StagesSection /></div>
          <FaqSection />
          <PartnersSection />
          <div ref={contactsRef as React.RefObject<HTMLDivElement>}><ContactsSection /></div>
        </main>
        <Footer />
      </div>
    </MotionConfig>
