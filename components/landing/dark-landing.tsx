...
export const NOMINATIONS: Nomination[] = [
  ...
  // 1.4 — Средства массовой информации
  {
    ...
    criteria: ["Значимость и актуальность материала", "Качество подачи и глубина раскрытия темы", "Охват и влияние публикации"],
  },
  {
    id: "12",
    category: "СМИ",
    ...
    accent: "#0804ff",
    description: "Описание номинации будет опубликовано в положении о премии.",
    criteria: ["Региональная значимость материала", "Качество подачи и глубина раскрытия темы", "Охват и влияние публикации"],
  },
  {
    id: "13",
    category: "СМИ",
...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Независимые эксперты — лидеры отрасли, педагоги, представители власти и ветераны РСО. Каждая номинация рассматривается профильной экспертной группой, затем шорт-лист утверждает Почётное жюри.",
  },
  {
  ...
  {
    q: "Что получают победители?",
    a: "Статуэтку, диплом, медиаподдержку РСО и публикацию в сборнике лучших практик. Церемония — 17 февраля 2027 в Москве с прямой трансляцией.",
  },
  {
    q: "Можно ли редактировать заявку после отправки?",
    a: "До дедлайна 30 ноября 2026 можно отозвать и подать заново через поддержку оргкомитета (r.s.o@mail.ru). После 30 ноября заявки уходят на оценку.",
  },
  {
