...
export const NOMINATIONS: Nomination[] = [
  ...
  },
  {
    ...
    criteria: ["Масштаб и охват деятельности студотрядов в вузе", "Система поддержки и развития студотрядов", "Достижения и результаты деятельности", "Взаимодействие с работодателями и партнёрами"],
  },
  {
    id: "04",
    category: "Ссуз / школа",
...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "В сезоне 2026 — 13 номинаций: от лучшего работодателя и вуза до лидера студотрядов и СМИ. Полный перечень с описанием — в разделе «Номинации» выше.",
  },
  {
