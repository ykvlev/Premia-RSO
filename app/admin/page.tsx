...
export default async function AdminPage() {
  ...
  const initialApps: MockApp[] = await Promise.all(rows.map(async (a) => {
    ...
    // Средний балл заявки = среднее суммарных оценок жюри (null, если не оценивали).
    ...
    // Официальные поля номинации (из formSchema) с ответами из payload —
    // для заявок, поданных через динамический третий шаг формы.
